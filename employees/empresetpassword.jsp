                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="logo pull-right">
                            <h1><a href="student.html">Intranet Portal</a></h1>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="login-wrapper">
                        <div class="box">
                            <div class="content-wrap">
                                ...
                                <form method="post" action="empchange" onsubmit="return validate()">
                                    <input hidden="true" type="password" name="pid" value="<%=pid%>">
