                            ...
                            <div class="content-wrap">
                                ...
                                <form method="post" action="emplogin">                                    
                                    <fieldset class="form-group">
                                        ...
                                        <input name="username" type="text" class="form-control" id="username" oninvalid="this.setCustomValidity('This field should not be left blank')" oninput="setCustomValidity('')" placeholder="Employee ID" required="true">
                                ...
                                <a href="emprecovery.jsp" class="btn btn-default btn-sm pull-left"><i class="fa fa-lock"></i> Change Password?</a>
                                <div class="btn-group pull-right">
                                    <button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">
                                        How to? <span class="caret"></span></button>
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="../public/uploads/userguides/sspr_doc.pdf" target="_blank">SSPR Manual</a></li>
                                        <li><a href="../public/uploads/userguides/Demo.mp4" target="_blank">SSPR Video</a></li>
                                    </ul>
                                </div>
                                <br/>
                            </div>
