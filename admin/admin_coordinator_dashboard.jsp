                    ...
                    <div class="sidebar content-box" style="display: block;">
                        <ul class="nav">
                            ...
                            <li class="submenu">
                                ...
                                <!-- Sub menu -->
                                <ul>
                                    <li><a ui-sref="students_coordinator"><i class="fa fa-edit"></i> Unverified</a></li>
                                    <li><a ui-sref="verified_coordinator"><i class="fa fa-pencil"></i> Verified</a></li>
                                </ul>
                            </li>
...
<!--                                    <li><a ui-sref=""><i class="fa fa-times"></i> Rejected</a></li>-->
                            ...
                            <li class="submenu">
                                ...
                                <!-- Sub menu -->
                                <ul>
                                    <li><a ui-sref="add_scholar_coordinator"><i class="glyphicon glyphicon-plus"></i> Add</a></li>
                                </ul>
                                <ul>
                                    <li><a ui-sref="view_scholar_coordinator"><i class="glyphicon glyphicon-eye-open"></i> View</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
