                    ...
                    <div class="sidebar content-box" style="display: block;">
                        <ul class="nav">
                            ...
                            <li class="submenu">
                                ...
                                <!-- Sub menu -->
                                <ul>
                                    <li><a ui-sref="students_dean"><i class="fa fa-edit"></i> Unverified</a></li>
                                    <li><a ui-sref="verified_dean"><i class="fa fa-pencil"></i> Verified</a></li>
                                </ul>                                
                            </li>
                            <li class="submenu">
                                <a href="#">
                                ...
                                <ul>
                                    <li><a ui-sref="approval_dean"><i class="glyphicon glyphicon-edit"></i> Pending Approval</a></li>
                                    <li><a ui-sref="approved_dean"><i class="glyphicon glyphicon-check"></i> Approved</a></li>
                                </ul>
                            </li>
                            <li class="submenu">
                                <a href="#">
                                ...
                                <!-- Sub menu -->
                                <ul>
                                    <li><a ui-sref="add_scholar_dean"><i class="glyphicon glyphicon-plus"></i> Add</a></li>
                                </ul>
                                <ul>
                                    <li><a ui-sref="view_scholar_dean"><i class="glyphicon glyphicon-eye-open"></i> View</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
