                ...
                <div class="col-md-2">
                    <div class="sidebar content-box" style="display: block;">
                        <ul class="nav">
                            ...
                            <li class="submenu">
                                <a href="#">
                                    <i class="fa fa-list"></i> Verification
                                    <span class="caret pull-right"></span>
                                </a>
                                <!-- Sub menu -->
                                <ul>
                                    <li><a ui-sref="upload_vdo"><i class="fa fa-edit"></i> Upload Video</a></li>
<!--                                <li><a ui-sref="verified_director"><i class="fa fa-pencil"></i> Verified</a></li>-->
                                </ul>
                            </li>
                        </ul>
                    </div>
