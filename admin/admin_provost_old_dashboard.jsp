                ...
                <div class="col-md-2">
                    <div class="sidebar content-box" style="display: block;">
                        <ul class="nav">
                            <li class="submenu">
                                <a href="#">
                                    New Registration <span class="caret pull-right"></span>
                                </a>
                                <ul>
                                    <li><a ui-sref="students_pst_old"><i class="fa fa-edit"></i> Unverified</a></li>
                                    <li><a ui-sref="verified_pst_old"><i class="fa fa-pencil"></i> Verified</a></li>
                                </ul>
                            </li>
                            <li class="submenu" ng-controller="ApprovalProvostCtrl">
                                <a href="#">
                                    Continuation <span class="caret pull-right"></span>
                                </a>
                                <ul>
                                    <li><a ui-sref="approval_pst"><i class="fa fa-edit"></i> Pending Approval <span class="badge pull-right">{{unapproved.length}}</span></a></li>
                                    <li><a ui-sref="approved_pst"><i class="fa fa-pencil"></i> Approved <span class="badge pull-right">{{approved.length}}</span></a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
