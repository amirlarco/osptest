<%--
    Document   : superadmin
    Created on : 1 Jun, 2016, 1 Jun, 2016 9:31:40 AM
    Author     : HP
--%>
                    ...
                    <div class="login-wrapper">
                        <div class="box">
                            <div class="content-wrap">
                                ...
                                <form method="post" action="superadminlogin">
                                    <fieldset class="form-group">
                                        <label for="username">ID Number</label>
                                        <input name="username" type="text" class="form-control" id="username" oninvalid="this.setCustomValidity('This field should not be left blank')" oninput="setCustomValidity('')" placeholder="ID Number" required="true">
