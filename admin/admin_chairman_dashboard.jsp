        ...
        <nav class="navbar navbar-default navbar-static-top">
            <div class="container-fluid">
                <div class="navbar-header" ng-controller="UserCtrl">
                    ...
                    <a class="navbar-brand" href="#"><i class="fa fa-bank"></i> {{user.label| uppercase}}</a>
                </div>
                    ...
                    <div class="sidebar content-box" style="display: block;">
                        <ul class="nav">
                            ...
                            <li class="submenu">
                                ...
                                <!-- Sub menu -->
                                <ul>
                                    <li><a ui-sref="students_chm"><i class="glyphicon glyphicon-edit"></i> Unverified</a></li>
                                    <li><a ui-sref="verified_chm"><i class="glyphicon glyphicon-check"></i> Verified</a></li>
                                </ul>
                            </li>
...
<!--                                    <li><a ui-sref=""><i class="fa fa-times"></i> Rejected</a></li>-->
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li><a ui-sref="view_scholar"><i class="glyphicon glyphicon-eye-open"></i> View</a></li>
                                    <li ng-controller="ResearchScholarPublishedCtrl"><a ui-sref="view_published"><i class="glyphicon glyphicon-upload"></i> Published<span class="badge pull-right">{{scholars.length}}</span></a></li>
                                    <li><a ui-sref="edit_published"><i class="glyphicon glyphicon-edit"></i> Edit Published</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
