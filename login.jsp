<%-- 
    Document   : login
    Created on : 19 Dec, 2016, 3:29:12 PM
    Author     : HP
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <link href="assets/uniform/css/uniform.default.min.css" rel="stylesheet" type="text/css"/>
        ...
        <link href="assets/page/login.min.css" rel="stylesheet" type="text/css"/>
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="index.html">
                <img src="assets/page/logo-big.png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
...
<![endif]-->
        ...
        <script src="assets/page/login.min.js" type="text/javascript"></script>
