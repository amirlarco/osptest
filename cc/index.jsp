<%-- 
    Document   : index
    Created on : 19 Nov, 2016, 3:23:49 PM
    Author     : developer
--%>
                            ...
                            <div class="content-wrap">
                                ...
                                <form method="post" action="login">
                                    <fieldset class="form-group">
                                        <label for="enroll">Username</label>
                                        <input name="enroll" type="text" class="form-control" id="enroll" placeholder="User Name" required oninvalid="this.setCustomValidity('This field should not be left blank')" oninput="setCustomValidity('')">
