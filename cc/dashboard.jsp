<%-- 
    Document   : dashboard
    Created on : 22 Nov, 2016, 11:14:54 AM
    Author     : Naved
--%>
                ...
                <div class="col-md-2">
                    <div class="sidebar content-box" style="display: block;">
                        <ul class="nav">
                            ...
                            <li class="submenu">
                                <a href="#">
                                    <i class="fa fa-list"></i> Apply for
                                    <span class="caret pull-right"></span>
                                </a>
                                <!-- Sub menu -->
                                <ul>
                                    <li> <a ui-sref="apply_wifi"><i class="fa fa-wifi"></i> Wifi</a></li>
                                    <li ng-if="user.profile.courseType === 'Research' || user.profile.courseType === 'PDF'"> <a ui-sref="apply_email"><i class="fa fa-at"></i> Email</a></li>
                                    <li> <a ui-sref="apply_gcl"><i class="fa fa-gitlab"></i> GCL Lab</a></li>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li> <a ui-sref="contact"><i class="fa fa-phone"></i> My Contact</a></li>
                                    <li> <a ui-sref="uploads"><i class="fa fa-upload"></i> Uploads</a></li>
                                    <li> <a ui-sref="change_mac"><i class="fa fa-cog"></i> Change MAC Address</a></li>
