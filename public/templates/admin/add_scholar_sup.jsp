<div ng-controller="ResearchScholarCtrl" class="row">
    <div class="col-lg-12">
        <section class="panel">
            <header class="panel-heading">
                <span class="glyphicon glyphicon-plus"></span> Add Research Scholar
            </header>
            <div ng-controller="ResearchScholarCtrl" class="panel-body"> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">                                
                            ...
                            <fieldset class="form-group">
                                ...
                                <input ng-model="idno" name="idno" type="text" class="form-control" id="title" placeholder="ID Number" pattern="\d{12,12}" required="true">
                            </fieldset>
                            <fieldset class="form-group">
