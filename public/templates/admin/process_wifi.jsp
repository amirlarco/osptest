<div class="row">
    <div ng-controller="ProcessWiFiCtrl">    
        <div class="col-xs-12">
            <section class="panel">
                <header class="panel-heading">
                    Process WiFi Accounts
                </header>
                <div class="panel-body">
                    <div ng-if="wifi_new.length > 0" class="pull-right">
                        <button class="btn btn-success btn-xs" ng-csv="getWifirequest" csv-header="getWiFiHeader()" filename="new_wifi_request.csv">
                            <i class="fa fa-file-excel-o"></i> Export to CSV
                        </button>
                        <button class="btn btn-danger btn-xs" ng-click="process_wifi()">
                    ...
                    <table class="table">
                        ...
                        <tr ng-repeat="student in wifi_new | orderBy: 'enroll'">                        
                            <td>{{$index + 1}}</td>
                            <td>
                                <input type="checkbox" ng-model="student.services[0].notified">
                            </td>
                            <td>
                            ...
                            <td>{{student.services[0].appliedOn}}</td>
                        </tr>                    
                    </table>
