<div class="panel-heading">
    <div class="page-title"><stron><span class="glyphicon glyphicon-check"></span> Approved Students</stron></div>
</div>
    ...
    <div class="row">
        <div class="col-xs-12"> 
            ...
            <div id="printarea" hidden="true">                
                <p>
                <center>List of Approved Students for continuation by: <strong>Chairperson {{dep}}</strong></center>
                </p>
                <table border="1">
                    <tr>
                        <th>SR#</th>                    
                    ...
                    <tr ng-repeat="student in approved | orderBy: 'profile.department'">
                        ...
                        <td>{{student.student[0].profile.city}}</td>
                        <td>{{student.student[0].profile.state}}</td>
                        <td>{{student.student[0].profile.country}}</td>
                    </tr>                    
                </table>
            </div>
            <table class="table table-striped">
                ...
                <tr ng-repeat="student in approved">                        
                    ...
                    <td>{{student.student[0].profile.courseName}}</td>
                    <td>{{student.student[0].profile.department}}</td>
                    <td>{{student.student[0].profile.hall}}</td>
                    <td>
                        <label class="label label-info">{{student.verification[0].status}}</label> 
                        <!-- <br> {{student.verification[0].actedBy}}<br> 
                        <small class="text-muted">{{student.verification[0].actedOn.$date | date:'medium'}}</small>-->
                    </td>
                </tr>                    
            </table>                                   
        </div>
