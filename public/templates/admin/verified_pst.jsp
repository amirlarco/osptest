        ...
        <div class="col-xs-12">           
            <form class="form-inline text-center" role="form" ng-submit="findVerified()">
                <div class="form-group">
                    <select class="form-control input-sm" ng-model="forVerified.dep" ng-options="x for x in distinct_deps | orderBy: 1" required="true">
            ...
            <br/>
            <div class="pull-right" ng-if="verified_by_provost.length > 0">
                <button class="btn btn-success btn-xs" ng-csv="getVerified" csv-header="getHeader()" filename="provost_verified.csv">
            ...
            <div id="printarea" hidden="true">                
                <p>
                <center>List of Verified Students by:<strong>Provost {{hall}}</strong></center>
                </p>
                <table border="1">
                    <tr>
                        <th>SR#</th>                    
                    ...
                    <tr ng-repeat="student in verified_by_provost| orderBy: 'profile.department'">
                        <td>{{$index + 1}}</td>
            ...
            <table class="table table-striped" ng-if="verified_by_provost.length > 0">
                <tr>
                    <th>SR#</th>                    
                    <th>Name of Students</th>
                    <th>Enrollment No</th>
                ...
                <tr ng-repeat="student in verified_by_provost | orderBy: 'fullName'">                        
                    <td>{{$index + 1}}</td>                    
                    <td>
