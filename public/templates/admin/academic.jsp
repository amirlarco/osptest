<div ng-controller="AcademicDepCtrl">
    <div class="col-sm-12">
        <section class="panel">
            ...
            <div class="panel-body">           
                <form class="form-inline text-center" role="form" ng-submit="findAcademicStaff()">
                    ...
                    <div class="form-group">
                        <select name="hall" class="form-control" ng-model="dep" ng-options="x.dname for x in academic_deps| orderBy: 1" required="true">
                ...
                <br/>
                <div class="pull-right" ng-if="academic_staff.length > 0">
                ...
                <div id="printarea" hidden="true">                
                    ...
                    <table border="1">
                        ...
                        <tr ng-repeat="staff in academic_staff| orderBy: 'orderlist'">
                            <td>{{$index + 1}}</td>
                            <td>{{staff.pid}}</td>
                            <td>{{staff.name}}</td>
                            <td>{{staff.desig}}</td>
                ...
                <table class="table table-striped" ng-if="academic_staff.length > 0">
                    <tr>
                        <th>SR#</th>                    
                        <th>Employee ID</th>
                        <th>Name</th>
