...
<div class="panel-heading">
    <div class="page-title"><strong><span class="glyphicon glyphicon-check"></span> Approved Students</strong></div>
</div>
<div class="panel-body" ng-controller="ApprovalDeanCtrl">
    <div class="row">
        <div class="col-xs-12">            
            <form class="form-inline text-center" role="form" ng-submit="getApprovedDean()">
                <div class="form-group">
                    <select class="form-control input-sm" ng-model="verified_dep" ng-options="x for x in departments" required="true">
            ...
            <div class="pull-right" ng-if="approved.length > 0">
                <button class="btn btn-success btn-xs" ng-csv="getApproved" csv-header="getHeaderA()" filename="dean_approved.csv">
            ...
            <div id="printarea" hidden="true">                
                ...
                <p>
                <center>
                    List of Approved Students of Department<strong>[{{verified_dep}}]</strong>
                    <br>As on <%=dt%>
                </center>
                </p>
                <table border="1">
                    ...
                    <tr ng-repeat="student in approved | orderBy: 'profile.department'">
                        ...
                        <td>{{student.type}}</td>
                        <td>{{student.verification[0].actedBy}}</td>
                    </tr>                    
                </table>
            </div>
            <table class="table table-striped" ng-if="approved.length > 0">
                <tr>                    
                    <th>SR#</th>                                     
                    <th>Name of Students</th>
                    <th>Enrollment No</th>
