        ...
        <div class="col-xs-12">
            <section class="panel">
                <header class="panel-heading">
                    Total Requests for Research Lab
                    <div class="pull-right">
                        <button class="btn btn-success btn-xs" ng-csv="getResearchrequest" csv-header="getResearchHeader()" filename="research_request.csv">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tr ng-repeat="student in research_new | orderBy: 'fullName'">                        
                        <td>{{$index + 1}}</td>
                        <td>
                        ...
                        <td>
                            <div ng-repeat="item in student.services">
                                <div ng-if="item.service === 'Research Lab'">
