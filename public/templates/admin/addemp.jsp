                ...
                <div class="row">
                    <div class="col-xs-8 col-xs-offset-2">
                        ...
                        <div ng-show="account === 'multi'">
                            <form class="form-horizontal" role="form" ng-submit="createPersona()">
                                <div class="form-group">
                                    <label for="pid" class="col-lg-3 col-sm-3 control-label">Employee ID</label>
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" ng-model="pid" ng-change="fetch()" placeholder="Employee ID" required="true"/>                                    
                                ...
                                <div class="form-group">
                                    <label for="persona" class="col-lg-3 col-sm-3 control-label">Persona</label>
                                    <div class="col-lg-8">
                                        <input class="form-control" ng-model="persona" placeholder="Username for Seondary Account" required="true"/>                                        
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="validity" class="col-lg-3 col-sm-3 control-label">Validity</label>
                                    <div class="col-lg-8">
                                        <input class="form-control" ng-model="validity" placeholder="DD-MM-YYYY" pattern="^(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d$" required="true"/>
                                        <small class="text text-muted text-danger">Hint: dd-mm-yyyy (eg. 31-12-1998 for DEC 31, 1998)</small>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="remark" class="col-lg-3 col-sm-3 control-label">Remark</label>
                                    <div class="col-lg-8">                                        
                                        <textarea class="form-control" ng-model="remark" minlength="30" required="true" placeholder="Mention the reseaon for secondary account creation..."></textarea>                                        
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div for="email" class="col-lg-3 col-sm-3"></div>
