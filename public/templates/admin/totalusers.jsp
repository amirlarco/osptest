    ...
    <div class="row">
        <div class="col-xs-12">
            <section class="panel">
                ...
                <div class="panel panel-body" ng-show="loading">
                    <center>
                        <i class='fa fa-spinner fa-pulse fa-3x'></i><br>
                        Please wait, loading large amount of data...
                    </center>
                </div>
                <div class="panel panel-body" ng-show="loaded">
                    <button class="btn btn-success btn-xs" ng-csv="getTotal" csv-header="getHeader()" filename="totalusers.csv">
                        <i class="fa fa-file-excel-o"></i> Export to CSV
                    </button>
                    Only those students whose profile is completed
<!--                    <table class="table table-striped col-xs-12">
                        ...
                        <tr ng-repeat="student in allusers">                        
                            <td>{{$index + 1}}</td>
                            <td>
                            ...
                            <td>{{student.profile.isCompleted}}</td>
                            <td>{{student.profile.services[0].created}}</td>
                        </tr>                    
                    </table>  -->
                </div>
            </section>
