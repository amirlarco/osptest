...
<div class="panel-body" ng-controller="ResearchScholarDeanCtrl">    
    <div class="panel-heading">
        <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-striped">
                    ...
                    <tr ng-repeat="scholar in scholars">                        
                        ...
                        <td>{{scholar.mode}}</td>
                        <td>{{scholar.regno}}</td>
                        <td>{{scholar.dor.$date| date}}</td>
                        <td>{{scholar.rtopic}}</td>
                        <td>{{scholar.doc.$date| date}}</td>
                        <td>
                            <div class="btn-group">
                                <button ng-disabled="scholar.status === 'Published' || scholar.status === 'Rejected'" type="button" data-toggle="dropdown" class="btn btn-default btn-xs dropdown-toggle">
                                    <span class="glyphicon glyphicon-option-horizontal"></span>
                                </button>
                                <ul class="dropdown-menu">                                    
                                    <li ng-show="scholar.status === 'Pending'"><a href="#" data-toggle="modal" data-target="{{'#' + scholar._id.$oid}}"><span class="glyphicon glyphicon-check"></span> Approve</a></li>
                                    <li ng-show="scholar.status === 'Pending'"><a href="#" data-toggle="modal" data-target="{{'#' + scholar.idno}}"><span class="glyphicon glyphicon-remove"></span> Reject</a></li>
                                    <li ng-show="scholar.status === 'Approved'"><a href="#" data-toggle="modal" data-target="{{'#' + scholar.regno}}"><span class="glyphicon glyphicon-upload"></span> Publish</a></li>
                                </ul>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form  ng-submit="deanAction('approve', scholar._id.$oid, scholar._id.$oid)">                                                    
                                                    <center>
                                ...
                                <div class="modal modal-wide fade" id="{{scholar.idno}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header text-center">
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            ...
                                            <div class="modal-footer">
                                                <form name="deanaction" ng-submit="deanAction('reject', scholar._id.$oid, scholar.idno)">                                                    
                                                    <fieldset class="form-group">
                                                        <label for="reject" class=" pull-left">Reason for rejection</label>
                                                        <input type="text" id="reject" ng-model="reject" class="form-control" placeholder="Write the reseaon for rejection..." required="true"/>
                                                    </fieldset>
                                                    <hr>
                                                    <center>
                                                        <fieldset class="form-group">
                                ...
                                <div class="modal modal-wide fade" id="{{scholar.regno}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form  ng-submit="deanAction('publish', scholar._id.$oid, scholar.regno)">                                                    
                                                    <center>
                                                        <input type="checkbox" name="declation" required="true"/>
