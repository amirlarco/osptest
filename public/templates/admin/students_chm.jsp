...
<div class="panel-body" ng-controller="VerificationChairmanCtrl">
    <div class="row">
        <div class="col-xs-12">
            ...
            <button ng-if="unverified.length > 0" class="btn btn-success btn-xs" ng-click="verify()">
                    <i class="fa fa-check"></i> Verify
                </button>
            <div ng-if="unverified.length > 0" class="pull-right">
                
                <button class="btn btn-success btn-xs" ng-csv="getUnverified" csv-header="getHeaderU()" filename="chairperson_unverified.csv">
            ...
            <div id="printarea" hidden="true">
                <p><strong>Important Note for Department Office</strong>: Kindly don't verify any request if it is not as per your record. If you found
