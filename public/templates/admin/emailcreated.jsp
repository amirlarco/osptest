            ...
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <div class="pull-right">
                        <button class="btn btn-success btn-xs" ng-csv="getEmailCreated" csv-header="getEmailHeader()" filename="email_request.csv">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tr ng-repeat="student in email_created | orderBy: '-services[3].createdOn.$date'">                        
                        <td>{{$index + 1}}</td>
                        <td>
                        ...
                        <td>{{student.services[3].createdOn.$date | date: 'medium'}}</td>
                    </tr>                    
                </table>
            </section>
        </div>
