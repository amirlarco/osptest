    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div ng-if="unapproved.length > 0" class="pull-right">
                ...
                <button class="btn btn-success btn-xs" ng-csv="getUnapproved" csv-header="getHeader()" filename="upapproved_provost.csv">
            ...
            <div id="printarea" hidden="true">
                ...
                <p>
                <center>
                    List of un-approved students for continuation at: <strong>Provost {{unapproved[0].details[1].hall}}</strong>
                    <br>As on <%=dt%>
                </center>
                </p>
                <table border="1">
