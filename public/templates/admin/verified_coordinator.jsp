<div class="panel-heading">
    <div class="page-title"><span class="glyphicon glyphicon-edit"></span> Verified Students</div>
</div>
<div class="panel-body" ng-controller="VerificationCoordinatorCtrl">    
    <div class="panel-heading">
        <div class="row">
            <div class="col-xs-12">            
                <table class="table table-striped">
                    ...
                    <tr ng-repeat="student in verified| orderBy: 'fullName'">                        
                        <td>{{$index + 1}}</td>                    
                        <td>
