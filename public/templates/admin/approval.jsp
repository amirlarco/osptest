...
<div class="panel-heading" ng-controller="ApprovalChairmanCtrl">
    <div class="page-title"><strong><span class="glyphicon glyphicon-edit"></span> Pending Approval <span class="badge">{{unapproved.length}}</span></strong></div>
</div>
<div class="panel-body" ng-controller="ApprovalChairmanCtrl">
    <div class="row">
        <div class="col-xs-12">
            <div ng-if="unapproved.length > 0" class="alert alert-warning">
                <strong>Important Note for Department Office</strong>: Kindly don't verify any request if it is not as per your record. If you found
                any student's information not matching as per your record leave as it is unverified. In case any student whose records are 
            ...
            <!--            <button ng-if="unapproved.length > 0" class="btn btn-success btn-xs" ng-click="verify()">
                            <i class="fa fa-check"></i> Approve
                        </button>-->
            <div ng-if="unapproved.length > 0" class="pull-right">

                <button class="btn btn-success btn-xs" ng-csv="getUnapproved" csv-header="getHeader()" filename="upapproved_chair.csv">
            ...
            <div id="printarea" hidden="true">
                ...
                <p>
                <center>
                    List of un-approved students for continuation at: <strong><%=label%></strong>
                    <br>As on <%=dt%>
                </center>
                </p>
                <table border="1">
