    ...
    <div class="row">
        <div class="col-xs-12"> 
            <div class="pull-right" ng-if="approved.length > 0">
                <button class="btn btn-success btn-xs" ng-csv="getApproved" csv-header="getHeaderA()" filename="chairperson_approved.csv">
            ...
            <div id="printarea" hidden="true">
                ...
                <p>
                <center>
                    List of Approved Students for continuation by: <strong><%=label%></strong>
                    <br>As on <%=dt%>
                </center>
                </p>
                <table border="1">
